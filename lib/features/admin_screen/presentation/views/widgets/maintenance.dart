...
import 'package:trucks/core/component/shimmer_effect/maintenance_shimmer_effect.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider<GetOutPaysCarsCubit>(
      ...
      child: Scaffold(
        ...
        body:
        BlocBuilder<GetOutPaysCarsCubit, GetOutPaysCarsState>(
          builder: (context, state) {
            if (state is GetOutPaysCarsLoadingState) {
              return const MaintenanceShimmerEffect();
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) => MaintanceForm(
